...
const case1 = setupCase('uniform()')

const case2 = setupCase('uniform(1,2,[2],xxx)')

const case3 = setupCase('floor(100 * uniform())')

const case4 = setupCase('type(xdebug)')

const case5 = setupCase('type([1,2])')

const case6 = setupCase('type(true && false)')
